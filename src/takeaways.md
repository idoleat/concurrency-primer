...
-   How atomic operations can be implemented on weakly-ordered hardware,
    and what implications this can have for a language-level <small>API</small>.
...
[^1]: See the LWN article,
    [*What is RCU, Fundamentally?*](https://lwn.net/Articles/262464/) for an introduction.
