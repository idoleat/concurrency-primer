...
Like many <small>RISC</small>[^1] architectures, <small>ARM</small> does not have dedicated <small>RMW</small> instructions.
...
[^1]: *Reduced instruction set computer*, in contrast to a *complex instruction set computer* (<small>CISC</small>) architecture like x64.
