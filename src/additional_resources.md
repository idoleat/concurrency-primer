...
by Fedor Pikus,
an hour-long talk on this topic.
...
[*`atomic<> Weapons`: The C++11 Memory Model and Modern Hardware*](https://herbsutter.com/2013/02/11/atomic-weapons-the-c-memory-model-and-modern-hardware/)
by Herb Sutter,
...
[`diy`](https://diy.inria.fr/),
plus the related
[`herdtools7`](https://github.com/herd/herdtools7) suite,
