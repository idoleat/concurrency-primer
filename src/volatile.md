...
Except for one specific case (see [Atomic fusion](./atomic_fusion.html)), this is false.
...
This is useful for memory-mapped <small>I/O</small> (<small>MMIO</small>),
...
1.  The compiler will not elide loads and stores that seem "unnecessary".
